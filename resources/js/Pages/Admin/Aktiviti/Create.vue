...
function submit() {
  form.post(route('admin.aktiviti.store'), { forceFormData: true })
}
</script>
...
<template>
  <div>
    ...
    <div class="flex items-center gap-4 mb-6">
      ...
      <div>
        <h1 class="text-2xl font-black text-slate-900">Tambah Aktiviti</h1>
        <p class="text-sm text-slate-500 mt-0.5">Cipta aktiviti baru untuk masjid</p>
      </div>
    </div>
          ...
          <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
                placeholder="Contoh: Dewan Masjid, Lot 3..."
              />
            ...
            <!-- Gambar Penutup -->
            <div>
              <label class="block text-sm font-semibold text-slate-700 mb-1.5">Gambar Penutup</label>
              <FileUploader
        ...
        <div class="space-y-5">
          ...
          <div class="flex flex-col gap-3">
            ...
            >
              ...
              {{ form.processing ? 'Menyimpan...' : 'Simpan Aktiviti' }}
            </button>
            <Link
              :href="route('admin.aktiviti.index')"
