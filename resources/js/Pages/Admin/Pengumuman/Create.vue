...
function submit() {
  form.post(route('admin.pengumuman.store'), { forceFormData: true })
}
</script>
...
<template>
  <div>
    ...
    <div class="flex items-center gap-4 mb-6">
      ...
      <div>
        <h1 class="text-2xl font-black text-slate-900">Tambah Pengumuman</h1>
        <p class="text-sm text-slate-500 mt-0.5">Cipta pengumuman baru untuk masjid</p>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-5">
          <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-5">
            ...
            <!-- Tarikh Terbit (if not published now) -->
